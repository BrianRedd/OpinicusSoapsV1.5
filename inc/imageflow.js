...
function ImageFlow ()
{
	...
	this.loadingProgress = function()
	{
		...
		if((p < 100 || my.firstCheck) && my.preloadImages)
		{
			...
			{
				my.firstCheck = false;
				setTimeout(my.loadingProgress, 100);
			}
			else
			{
				setTimeout(my.loadingProgress, 40);
			}
		}
		else
		{
			...
			setTimeout(my.Helper.addResizeEvent, 1000);
	...
	this.animate = function()
	{
		switch (my.target < my.current-1 || my.target > my.current+1)
		{
			case true:
				...
				setTimeout(my.animate, my.animationSpeed);
				my.busy = true;
				break;
	...
	this.Slideshow =
	{
		...
		start: function()
		{
			...
			/* Set slide interval */
			my.Slideshow.action = setInterval(my.Slideshow.slide, my.slideshowSpeed);

			/* Allow the user to always interrupt the slideshow */
			setTimeout(my.Slideshow.addInterruptEvent, 100);
		},
		...
		stop: function()
		{
			...
			clearInterval(my.Slideshow.action);
		},
